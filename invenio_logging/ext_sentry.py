...
class InvenioLoggingSentry(object):
    ...
    def sentry_include_paths(self):
        """Detect Invenio dependencies and for use
         with SENTRY_INCLUDE_PATHS."""
        try:
    ...
    def init_app(self, app):
        ...
        if app.config['SENTRY_DSN']:
            ...
            # import invenio #TODO could be removed?
            # import webassets
            import setuptools
            ...
            # if self.is_being_tested:  #TODO spoof only captureMock object
            #     s.captureMessage = self.test_param

            # Replace method with more robust version
            s.add_sentry_id_header = self.add_sentry_id_header

            # Add extra tags information to sentry. TODO fix constant -->
            # invenio.__version__
            s.client.extra_context({'version': 4247})
